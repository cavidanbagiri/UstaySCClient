<template>
    <thead class="text-xs text-black bg-gray-100 dark:bg-gray-700 dark:text-gray-400 border w-full"  style="font-family: Verdana, Geneva, Tahoma, sans-serif; letter-spacing: 1px;">
        <tr class="">
