...
<template>
    <tr :class="checked ? 'text-white  bg-blue-600 hover:bg-blue-500 ' : 'hover:bg-gray-100'"
        ...
        <th v-for="i in procurement_store.sm_table_headers" v-show="i.value" class="px-2 py-2 font-medium text-center">
            ...
            <!-- Situation Design -->
            <div v-else-if="i.name === 'situation'" class="text-start">
