<template>
    <tbody>
        ...
        <Get_Receiving_STF_Table_Body_Each_Row_Comp 
        v-for="(each_item, index) in procurement_store.receiving_sms"
...
import Get_Receiving_STF_Table_Body_Each_Row_Comp from './Get_Receiving_STF_Table_Body_Each_Row_Comp.vue';
